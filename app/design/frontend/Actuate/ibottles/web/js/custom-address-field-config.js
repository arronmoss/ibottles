define(['jquery', 'underscore'], function($, _) {
    ...
    var vatNumber = ['AT','BE','BG','HR','CH','CY','CZ','DK','EE','FI','FR','DE','GR','HU','IE','IS','IT','LV','LT','LU','MT','NL','NO','PL','PT','RO','SK','SI','ES','SE'];
    var eoriNumber = ['AT','BE','BG','HR','CH','CY','CZ','DK','EE','FI','FR','DE','GR','HU','IE','IS','IT','LV','LT','LU','MT','NL','NO','PL','PT','RO','SK','SI','ES','SE'];
    ...
    return {
		...
		Business EORI Number: Austria, Belgium, Bulgaria, Croatia, Cyprus, Czech Republic, Denmark, Estonia, Finland, France, Germany, Greece, Hungary, Ireland, Iceland, Italy, Latvia, Lithuania, Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Romania, Slovakia, Slovenia, Spain, Sweden and Switzerland.
		*/
        config: {
            /* checkout */
